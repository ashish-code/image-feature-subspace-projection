...
Compute the svm classification score of various pca, spca, sspca, rpca, kpca methods
for various visual datasets
@author: ag00087
'''
...
def computePerformanceMetrics(dataset,method,highDim,lowDim):
    ...
    f1scoreAvgFile = resultRootDir+dataset+'/'+str(highDim)+str(lowDim)+method+'.f1avg'
    f1scoreStdFile = resultRootDir+dataset+'/'+str(highDim)+str(lowDim)+method+'.f1std'
    precisionFile =resultRootDir+dataset+'/'+str(highDim)+str(lowDim)+method+'.pre'
    recallFile = resultRootDir+dataset+'/'+str(highDim)+str(lowDim)+method+'.rec'
