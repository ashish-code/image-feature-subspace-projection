% compute classification performance of subspace methods

function calcSubspaceClassPerf(dataSet,dictType,dictSize,method)
...
coeffPerfFileAvg  = strcat(rootDir,dataSet,coeffPerfDir,algo,num2str(param),method,'.avg');
coeffPerfAvg = zeros(nCategory,3);
listSize = 30;

% if exist(coeffPerfFileAvg,'file')
%     fprintf('%s,%s\n','EXISTS',coeffPerfFileAvg);
%     return;
% end
